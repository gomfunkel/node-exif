...
ExifImage.prototype.extractExifData = function (data, start, length) {
	...
	// it if available
	if (typeof this.exifData.image[ExifImage.TAGS.tiff[0x8769]] != "undefined") {

		ifdOffset = tiffOffset + this.exifData.image[ExifImage.TAGS.tiff[0x8769]].value;
		numberOfEntries = data.getShort(ifdOffset, this.isBigEndian);
	...
	// it if available
	if (typeof this.exifData.image[ExifImage.TAGS.tiff[0x8825]] != "undefined") {

		ifdOffset = tiffOffset + this.exifData.image[ExifImage.TAGS.tiff[0x8825]].value;
		numberOfEntries = data.getShort(ifdOffset, this.isBigEndian);
